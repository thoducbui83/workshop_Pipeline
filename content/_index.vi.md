---
title : "Pipeline Xử lý Dữ liệu Serverless sử dụng AWS Step Functions và EventBridge"
date: 2025-07-02 
weight : 1 
chapter : false
---
# Làm việc với Pipeline Xử lý Dữ liệu Serverless sử dụng AWS Step Functions và EventBridge
...
![ConnectPrivate](/workshop_Pipeline/images/arc-logdemo.png) 

### Nội dung

 1. [Giới thiệu](1-introduce/)
 2. [Các bước chuẩn bị](2-prerequiste/)
 3. [Kết quả](3-accessibilitytoinstances/)
